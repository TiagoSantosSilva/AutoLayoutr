...
extension ViewController {
    ...
    fileprivate func setupPreviousButton() {
        ...
        previousButton.setButtonAnchors(bottomAnchor: view.safeAreaLayoutGuide.bottomAnchor, leadingAnchor: view.leadingAnchor, trailingAnchor: view.trailingAnchor, heightConstant: 50)
    }
